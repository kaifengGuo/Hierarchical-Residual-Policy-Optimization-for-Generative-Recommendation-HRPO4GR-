...
do
    ...
    do
        ...
        do
            ...
            do
                for SEED in 2026 # 11 13 17 19 23
                do
                    file_key=td3_${POLICY_CLASS}_${ENV_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_fret${FEEDBACK_INF_RETURN}_seed${SEED}_slatesize${SLATE_SIZE}
