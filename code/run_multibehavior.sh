...
# data source path
data_path=/root/lanyun-tmp/KuaiSim-baseline/KuaiSim-main/dataset/kuairand/kuairand-${KR_FLAG}/data/
...
do
    ...
    do
        for N_LAYER in 2
        do
            file_key=user_${MODEL}_lr${LR}_reg${REG}_nlayer${N_LAYER}_full
            python train_multibehavior.py\
                ...
                --train_file ${data_path}log_full_session_4_08_to_5_08_${KR_FLAG}.csv\
